...
const defaultServices: Service[] = [
  {
    ...
    name: 'پک مراقبت روزمره موتور',
    description:
      'شامل روغن تمام‌سنتتیک، فیلتر روغن و فیلتر هوا برای تعویض دوره‌ای خودروهای شهری و استفاده روزانه.',
    duration: 'مناسب برای خودروهای سواری بنزینی',
    price: 2450000
  },
  {
    id: 'bundle-long-life',
    name: 'پک دوام بالا',
    description:
      'روغن Long Life اروپایی همراه با افزودنی محافظ موتور و فیلتر بنزین کم‌مصرف ویژه سفرهای طولانی.',
    duration: 'پیشنهادی برای سفرهای جاده‌ای',
    price: 3980000
  },
  {
    id: 'bundle-diesel',
    name: 'پک ویژه خودروهای دیزل',
    description:
      'روغن کم‌خاکستر C3 در کنار فیلتر گازوئیل دو مرحله‌ای و فیلتر روغن صنعتی برای وانت و کراس‌اوورهای دیزل.',
    duration: 'سازگار با موتورهای دیزل مدرن',
    price: 4550000
  }
];
...
export async function createAiSession(topic: string): Promise<ChatSession> {
  ...
  const welcomeMessage: ChatMessage = {
    ...
    role: 'assistant',
    content: 'سلام! من دستیار هوشمند مانی اویل هستم. درباره انتخاب روغن یا فیلتر سوالی داری؟ بپرس تا راهنمایی کنم.',
    createdAt: now
  };
