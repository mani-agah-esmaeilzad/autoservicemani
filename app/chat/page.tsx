...
const initialAssistantMessage: ChatMessage = {
  ...
  role: 'assistant',
  content:
    'سلام! من دستیار هوشمند Mani Oil هستم. هر سوالی درباره انتخاب روغن، فیلتر و نگهداری خودرو دارید بپرسید تا راهنمایی تخصصی دریافت کنید.',
    ...
    <div className="section">
      <div className="container chat-page">
        ...
        <footer className="chat-page__footer">
          <p>
            پاسخ‌های ارائه شده توسط دستیار هوشمند صرفاً جهت راهنمایی هستند. برای تعمیرات حساس حتماً با کارشناسان حضوری مانی اویل یا نمایندگی خودرو هماهنگ کنید.
          </p>
        </footer>
      </div>
    </div>
